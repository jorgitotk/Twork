class Admin::WorkGroupsController < AdminController
  ...
  def create
    ...
    @work_group.owner = current_user
    @work_group.save if @work_group.valid?
  end
  ...
  def add_member
    ...
    @member.save unless User.find_by(id: member_params[:user_id]).nil?
  end
